...
<head>
    ...
    <title>Login - CMS Pengajian Admin</title>
                ...
                <?php echo form_open('admin/auth/login'); ?>
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="username" name="username" value="<?php echo set_value('username'); ?>" placeholder="Enter username" required autofocus>
                        </div>
                    </div>
